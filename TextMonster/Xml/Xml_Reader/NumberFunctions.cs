...
namespace TextMonster.Xml.Xml_Reader
{
  internal sealed class NumberFunctions : ValueQuery
  {
    ...
    public override object Evaluate(XPathNodeIterator nodeIterator)
    {
      switch (ftype)
      {
        case Function.FunctionType.FuncNumber: return Number(nodeIterator);
        case Function.FunctionType.FuncSum: return Sum(nodeIterator);
        case Function.FunctionType.FuncFloor: return Floor(nodeIterator);
        case Function.FunctionType.FuncCeiling: return Ceiling(nodeIterator);
        case Function.FunctionType.FuncRound: return Round(nodeIterator);
      }
      return null;
    }
